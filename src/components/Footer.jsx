...
export default function Footer() {
    ...
    return (
        ...
        <footer className=" shadow dark:bg-brand-dark  bg-brand-200 px-4 ">
            ...
            <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="/" className="hover:underline">Lexis Bonilla</a>. All Rights Reserved.</span>
