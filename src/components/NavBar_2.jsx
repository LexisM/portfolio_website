...
function NavBar({ onChange }) {
    ...
    return (
        ...
        <nav className="bg-brand-200 dark:bg-brand-dark fixed w-full z-20 top-0 start-0 border-b-2 border-primary">
            <animated.div style={props}>
                <div className=" container flex flex-wrap items-center justify-between mx-auto py-2">
                    ...
                    <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                        <ul className=" text-center flex flex-col font-bold  text-brand dark:text-brand-200 bg-brand-200 dark:bg-brand-dark  md:space-x-8 rtl:space-x-reverse md:flex-row   ">
                            <li className="">
                                <a href="#" className="block py-2 px-3 rounded   md:p-0 " aria-current="Home Page">Home</a>
                            </li >
                            <li className="">
