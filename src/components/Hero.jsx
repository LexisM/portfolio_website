                ...
                <div className="flex flex-col items-center md:justify-between  md:flex-row box-border  ">
                    ...
                    <animated.div className="mt-0 flex-row w-full justify-center md:w-1/2 " style={props}>
                        ...
                        <div className="flex space-x-2 my-10 md:mt-30 justify-center md:justify-start 2 items-center">
                            <a href="./src/Files/resume.pdf" target="_blank" rel="noreferrer" className="  p-2 mx-3 md:p-6 text-md md:text-xl font-bold text-center leading-10 dark:text-brand rounded-md dark:bg-accent  dark:hover:bg-accent-600 border-b-2 border-secondary bg-brand hover:bg-secondary text-white" >Dowload CV  </a>
